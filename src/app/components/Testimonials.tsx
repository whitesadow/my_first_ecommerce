    ...
    <div>
        <div className="container pt-16 pb-16 grid-cols-2">
            ...
            <div className="grid lg:grid-cols-[300px, 1fr] gap-4">
                ...
                alt="dp"
                />
                <h2 className="text-gray-500 font-block text[20px]">Julian García.</h2>
                ...
                <p className="max-w-[200px] text-gray-500">
                    OJAG es una nueva experiencia de compra de articulos de fashion
                    con la mejor asesoria y gran empatia.
                </p>
                </div>
            </div>
            ...
            grid place-items-center">
                ...
                rounded-xl py-8 sm:px-8 px-2 grid place-items-center gap-3">
                    <button className="bg-primary-blackish text-white p-2 rounded-md">
                        25% DISCOUNT
                    </button>
